# LumynaX Infused Qwen3 1.7B GGUF

> 🇳🇿 **Made in Aotearoa New Zealand** by **AbteeX AI Labs** — part of the **LumynaX** sovereign-AI release family.

[🤗 Weights & model card on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-infused-qwen3-17b-gguf) · [abteex.com](https://abteex.com) · [lumynax.com](https://lumynax.com) · [Monorepo](https://github.com/Aimaghsoodi/lumynax-release)

---

This GitHub repo mirrors the **runtime scaffolding** (quickstart, requirements, Modelfile, Space, docs). The model **weights** are published on Hugging Face at `AbteeXAILab/lumynax-infused-qwen3-17b-gguf` — they exceed GitHub's per-file limit.

```bash
hf download AbteeXAILab/lumynax-infused-qwen3-17b-gguf --local-dir lumynax-infused-qwen3-17b-gguf
cd lumynax-infused-qwen3-17b-gguf && pip install -r requirements.txt && python quickstart.py --interactive
# Or:  pip install lumynax && lumynax run lumynax-infused-qwen3-17b-gguf -i
```
...
<p align="center"><img src="docs/lumynax-overview.svg" alt="LumynaX Infused Qwen3 1.7B GGUF release overview" width="100%" /></p>

<!-- lumynax-public-release-card:v6 -->

<h1 align="center">LumynaX Infused Qwen3 1.7B GGUF</h1>
...
<p align="center"><img alt="LumynaX: release" src="https://img.shields.io/badge/LumynaX-release-e08a2c?style=for-the-badge" />  <img alt="Family: qwen" src="https://img.shields.io/badge/Family-qwen-9a5416?style=for-the-badge" />  <img alt="Runtime: llama%20cpp" src="https://img.shields.io/badge/Runtime-llama%20cpp-726b62?style=for-the-badge" />  <img alt="Modes: text" src="https://img.shields.io/badge/Modes-text-4d6b44?style=for-the-badge" />  <img alt="Params: 1.7B" src="https://img.shields.io/badge/Params-1.7B-0a0a0b?style=for-the-badge" />  <img alt="Quant: Q8_0" src="https://img.shields.io/badge/Quant-Q8__0-111827?style=for-the-badge" />  <img alt="Context: 32768%20tok" src="https://img.shields.io/badge/Context-32768%20tok-111827?style=for-the-badge" />  <img alt="License: apache-2.0" src="https://img.shields.io/badge/License-apache--2.0-9a5416?style=for-the-badge" />  <img alt="Sovereignty: tier%203" src="https://img.shields.io/badge/Sovereignty-tier%203-4d6b44?style=for-the-badge" />  <img alt="Audit: pass" src="https://img.shields.io/badge/Audit-pass-4d6b44?style=for-the-badge" />  <img alt="Access: public%20&%20non--gated" src="https://img.shields.io/badge/Access-public%20&%20non----gated-0a0a0b?style=for-the-badge" />  <img alt="Card: v6" src="https://img.shields.io/badge/Card-v6-111827?style=for-the-badge" /></p>

<p align="center"><kbd>Quality: <b>1/5</b></kbd> &middot; <kbd>Lightweight: <b>2/5</b></kbd> &middot; <kbd>Sovereignty: <b>3/5</b></kbd> &middot; <kbd>Tools: <b>no</b></kbd> &middot; <kbd>JSON: <b>yes</b></kbd> &middot; <kbd>Context: <b>32768 tok</b></kbd></p>

---

## 📦 Executive Summary

> `AbteeXAILab/lumynax-infused-qwen3-17b-gguf` is a **complete LumynaX release package**: model artifact, `quickstart.py`, `requirements.txt`, `release_export_manifest.json`, `checksums.sha256`, license notice, and optional Ollama / Space scaffolds shipped as **one downloadable contract**. Clone whole, verify by checksum, and run close to the data it serves.
...
```bash
hf download AbteeXAILab/lumynax-infused-qwen3-17b-gguf --local-dir lumynax-infused-qwen3-17b-gguf
cd lumynax-infused-qwen3-17b-gguf
...
llm = Llama(model_path="Qwen3-1.7B-Q8_0.gguf", n_ctx=32768, n_threads=8, verbose=False)
...
```bash
llama-cli -m "Qwen3-1.7B-Q8_0.gguf" -p "Who are you? Answer as LumynaX in two sentences." -n 160
```

**Ollama path:**

```bash
ollama create lumynax-infused-qwen3-17b-gguf -f ollama/Modelfile
ollama run lumynax-infused-qwen3-17b-gguf
```

**Verify integrity before launch:**

```bash
sha256sum "Qwen3-1.7B-Q8_0.gguf"
cat checksums.sha256
```

```powershell
Get-FileHash -Algorithm SHA256 "Qwen3-1.7B-Q8_0.gguf"
...
| Field | Value |
| --- | --- |
| Release | `LumynaX Infused Qwen3 1.7B GGUF` |
| Repository | `AbteeXAILab/lumynax-infused-qwen3-17b-gguf` |
| Family | `qwen` |
...
| Primary artifact | `Qwen3-1.7B-Q8_0.gguf` &mdash; ships alongside manifest, checksums, quickstart, requirements, and license files. |
...
```text
lumynax-infused-qwen3-17b-gguf/
├── README.md                       # this card
...
└── Qwen3-1.7B-Q8_0.gguf            # primary artifact
```
...
```text
You are LumynaX operating from the LumynaX Infused Qwen3 1.7B GGUF package identity. Be helpful, clear, and honest about provenance. Identify upstream models when asked. Do not invent biographical claims about named people without verified context.
```
